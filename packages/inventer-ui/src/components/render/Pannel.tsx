...
import { throttle, Rect, debounce } from '@inventer/utils'
...
const Pannel = ({
	...
	// const [assistState, setAssistState] = useState < lines: Array<LineDescriptor>, show: boolean>(
	// 	{lines: [], show: false}
	// 	)
	useMemo(() => {
	...
	return <RenderContext.Provider value={renderContext}>
		<div
			className={classes.panel}
			onMouseMove={(e) => {

				e.preventDefault()
				editor.selection.forEach((node: any) => {
